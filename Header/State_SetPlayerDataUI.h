...
private:
	...
	// 全角文字
	static constexpr wchar_t FULL_WORD[49] = { '０', '１', '２', '３', '４', '５', '６', '７', '８', '９', 'ａ', 'ｂ', 'ｃ', 'ｄ', 'ｅ', 'ｆ', 'ｇ', 'ｈ', 'ｉ', 'ｊ', 'ｋ', 'ｌ', 'ｍ', 'ｎ', 'ｏ', 'ｐ', 'ｑ', 'ｒ', 'ｓ', 'ｔ', 'ｕ', 'ｖ', 'ｗ', 'ｘ', 'ｙ', 'ｚ', '：', '；', '、', 'ー', '。', '・', '＠', '「', '￥', '」', '＾', '￥', '　' };
	static constexpr wchar_t FULL_CAPITAL_WORD[49] = { NULL, '！', '”', '＃', '＄', '％', '＆', '’', '（', '）', 'Ａ', 'Ｂ', 'Ｃ', 'Ｄ', 'Ｅ', 'Ｆ', 'Ｇ', 'Ｈ', 'Ｉ', 'Ｊ', 'Ｋ', 'Ｌ', 'Ｍ', 'Ｎ', 'Ｏ', 'Ｐ', 'Ｑ', 'Ｒ', 'Ｓ', 'Ｔ', 'Ｕ', 'Ｖ', 'Ｗ', 'Ｘ', 'Ｙ', 'Ｚ', '＊', '＋', '＜', '＝', '＞', '？', '‘', '｛', '｜', '｝', '～', '＿', ' ' };
